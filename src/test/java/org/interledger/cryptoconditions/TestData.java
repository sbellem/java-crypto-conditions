...
public class TestData {
  ...
  public static final byte[] PreimageSha256Condition0x00 = new byte[] {0x00, 0x00, // Type =
                                                                                   // PREIMAGE
                                                                                   // SHA256
  ...
  public static final byte[] PreimageSha256Condition0xFF = new byte[] {0x00, 0x00, // Type =
                                                                                   // PREIMAGE
                                                                                   // SHA256
      0x01, 0x03, // Features = SHA256 and PREIMAGE
  ...
  public static final String[] Base64URLEncoded = new String[] { /*
                                                                  * "random" Base64URL encoded
                                                                  * strings extracted from
                                                                  * five-bells-conditions Tests
                                                                  */
      "ff00ff00abab", "O2onvM62pC1io6jQKm8Nc2UyFXcd4kOmOsBIoYtZ2ik",
      "RCmTBlAEqh5MSPTdAVgZTAI0m8xmTNluQA6iaZGKjVE", "Yja3qFj7NS_VwwE7aJjPJos-uFCzStJlJLD4VsNy2XM",
